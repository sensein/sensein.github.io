...
<img src="{{ "/images/mapper_blogpost/1_ghrist.webp" | prepend: site.baseurl | prepend: site.url}}" class="img-responsive" width="50%" />
...
<img src="{{ "/images/mapper_blogpost/2_jacobbriones1.webp" | prepend: site.baseurl | prepend: site.url}}" class="img-responsive" width="50%" />
*A cool gif showing how links between nodes are formed as epsilon is varied. ([source](https://jacobbriones1.github.io/tda1/))*

<img src="{{ "/images/mapper_blogpost/3_ghrist.webp" | prepend: site.baseurl | prepend: site.url}}" class="img-responsive" width="50%" />
...
<img src="{{ "/images/mapper_blogpost/4_ghrist.webp" | prepend: site.baseurl | prepend: site.url}}" class="img-responsive" width="50%" />
...
<img src="{{ "/images/mapper_blogpost/5_dyneusr.webp" | prepend: site.baseurl | prepend: site.url}}" class="img-responsive" width="50%" />
...
<img src="{{ "/images/mapper_blogpost/6_saggar.webp" | prepend: site.baseurl | prepend: site.url}}" class="img-responsive" width="50%" />
...
<img src="{{ "/images/mapper_blogpost/7_faskowitz.webp" | prepend: site.baseurl | prepend: site.url}}" class="img-responsive" />
